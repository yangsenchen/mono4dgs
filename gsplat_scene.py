...
class GSSolver:
    ...
    def __init__(self, data_path: str, sam2_video_path: str, focal_ratio: float = 0.8):
    ...
    def run(self):
        ...
        print("=== Starting Spherical Car Reconstruction ===")
...
if __name__ == "__main__":
    ...
    sam2_path = "sam2.mp4" # 请确认文件名正确

    

    tyro.cli(lambda: GSSolver(npz_path, sam2_path).run())